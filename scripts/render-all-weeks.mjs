...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:var(--paper);color:var(--ink);font:17px/1.78 Arial,"Microsoft YaHei",sans-serif}
    ...
    .hero{padding:84px max(24px,calc((100vw - 1040px)/2)) 66px;background:var(--deep);color:#f7f6f0}.hero small{color:var(--acid);font-weight:800;letter-spacing:.13em}
    ...
    details{margin:25px 0;padding:16px 18px;border:1px solid var(--line);background:#fff}summary{cursor:pointer}
    aside{position:sticky;top:90px;height:max-content;border-left:1px solid var(--line);padding-left:20px}aside strong{display:block;font-size:11px;letter-spacing:.12em;margin-bottom:11px;color:var(--muted)}
    aside a{display:block;font-size:13px;line-height:1.35;margin:0 0 10px;text-decoration:none;color:var(--muted)}aside a:hover{color:var(--deep)}
